...
export class FirstTabComponent implements OnInit {
  ...
  addItemFormGroup() {
    const item = this.fb.group({
      ...
      count: [1, [Validators.required, Validators.minLength(1), Validators.maxLength(100), Validators.pattern("^[0-9]*$")]],
      price: ['', [Validators.required, Validators.minLength(1), Validators.maxLength(1000000), Validators.pattern("^[0-9]*$")]]
    });
